...
import com.hq.base.view.banner.BGABanner;
import com.hq.base.view.banner.transformer.TransitionEffect;
...
public class BannerActivity extends BaseActivity implements BGABanner.Delegate<ImageView, String>, BGABanner.Adapter<ImageView, String> {
    ...
    private void loadData(final BGABanner banner, final int count) {
        ...
        bannerModel.imgs.add("http://imgsrc.baidu.com/imgad/pic/item/267f9e2f07082838b5168c32b299a9014c08f1f9.jpg");
        bannerModel.imgs.add("http://pic.58pic.com/58pic/13/85/85/73T58PIC9aj_1024.jpg");
//        bannerModel.tips.add("111");
//        bannerModel.tips.add("222");
...
//                Toast.makeText(mContext, "网络数据加载失败", Toast.LENGTH_SHORT).show();
//            }
//        });
    ...
    public void fillBannerItem(BGABanner banner, ImageView itemView, String model, int position) {
        Glide.with(itemView.getContext())
                ...
                .error(R.drawable.ic_prompt_loading)
                .dontAnimate()
                .centerCrop()
                .into(itemView);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_main_get_item_count:
                Toast.makeText(mContext, "广告条总页数为 " + mDefaultBanner.getItemCount(), Toast.LENGTH_SHORT).show();
                break;
            case R.id.tv_main_get_current_item:
                Toast.makeText(mContext, "广告当前索引位置为 " + mDefaultBanner.getCurrentItem(), Toast.LENGTH_SHORT).show();
                break;
