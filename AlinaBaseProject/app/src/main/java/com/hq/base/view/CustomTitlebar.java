...
public class CustomTitlebar extends RelativeLayout implements OnClickListener
{
    ...
    private ILeftClick mILeftClick;

    private IRightClick mIRightClick;
    ...
    public void setAction(ILeftClick listener)
    {
        mLeft.setOnClickListener(this);
        mRight.setOnClickListener(this);
        mILeftClick = listener;
    }

    public void setAction(IRightClick listener)
    {
        mLeft.setOnClickListener(this);
        mRight.setOnClickListener(this);
        mIRightClick = listener;
    }

    public void setAction(ILeftClick listener, IRightClick listener1)
    {
        mLeft.setOnClickListener(this);
        mRight.setOnClickListener(this);
        mILeftClick = listener;
        mIRightClick = listener1;
    }
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            case R.id.rl_left:
                ...
                break;
            case R.id.rl_right:
                if (mIRightClick!=null){
                    mIRightClick.doRight();
                }
                break;
        }
    }
